...
public class CreateUserTest {
    ...
    @Test
    @Step("Создать нового уникального пользователя")
    ...
    public void uniqueUserShouldBeCreated() {
        ...
        //создание
        //из тела вытаскиваем access token
    ...
    @Test
    @Step("Создать пользователя с незаполненным email")
    ...
    @Test
    @Step("Создать пользователя без указания пароля")
    ...
    @Test
    @Step("Создать пользователя без указания name")
